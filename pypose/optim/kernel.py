...
class Tolerant(nn.Module):
    ...
    Args:
        a (float, optional): Specify the Tolerant cost. The value must be positive. Default: 1.0
        b (float, optional): Specify the Tolerant cost. The value must be positive. Default: 1.0
