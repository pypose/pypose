...
class System(nn.Module):
    ...
    def A(self):
        ...
        '''
        return sysmat(self, self._ref_state, self._ref_input, self._ref_t)[0]
    ...
    def B(self):
        ...
        '''
        return sysmat(self, self._ref_state, self._ref_input, self._ref_t)[1]
    ...
    def C(self):
        ...
        '''
        return sysmat(self, self._ref_state, self._ref_input, self._ref_t)[2]
    ...
    def D(self):
        ...
        '''
        return sysmat(self, self._ref_state, self._ref_input, self._ref_t)[3]
...
class LTV(System):
    ...
    def state_transition(self, state, input, t=None):
        ...
        Returns:
            ``Tensor``: The state the system in next time step.
        '''
        z = bmv(self._A(t), state) + bmv(self._B(t), input)
        return z if self.c1 is None else z + self.c1
    ...
    def observation(self, state, input, t):
        ...
        Returns:
            ``Tensor``: The observation of the system in next time step.
        '''
        y = bmv(self._C(t), state) + bmv(self._D(t), input)
        return y if self.c2 is None else y + self.c2
