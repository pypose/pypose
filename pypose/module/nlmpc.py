...
class NLMPC(nn.Module):
    ...
    def forward(self, x_init, current_x, current_u, Q, p, time):
        ...
        for i in range(self.step):
            ...
            nlqr = pp.module.NLQR(self.system, Q, p, self.T)
        ...
        _nlqr = pp.module.NLQR(self.system, Q, p, self.T)
        x, u, cost= _nlqr(x_init, current_x, current_u, time)
