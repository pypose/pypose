...
class MPC2(nn.Module):
    ...
    def forward(self, Q, p, x_init, dt, current_x=None, current_u=None,
        ...
        for i in range(self.step):
            if u is not None:
                u = u.detach()
            lqr = pp.module.LQR2(self.system, Q, p, self.T)
            x, u, cost = lqr(x_init, dt, x, u, u_lower, u_upper, du)
        ...
        _lqr = pp.module.LQR2(self.system, Q, p, self.T)
        x, u, cost= _lqr(x_init, dt, current_x, current_u, u_lower, u_upper, du)
