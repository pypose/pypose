...
if __name__ == '__main__':
    ...
    parser.add_argument("--save", type=str, default='./examples/pgo/save/', help="location of png files to save")
    parser.add_argument("--dataroot", type=str, default='./examples/pgo/pgodata', help="dataset location downloaded")
