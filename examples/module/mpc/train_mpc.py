...
def main():
    ...
    def get_loss(x_init, _A, _B):
        ...
        _lqr2 = mpc.MPC(lti, u_init=u_init, lqr_iter=1)
        x_true, u_true, cost_true = _lqr2.forward(x_init, expert['Q'], expert['p'])

        lti_ = pp.module.LTI(_A, _B, C, D, c1, c2)
        _lqr2 = mpc.MPC(lti_, u_init=u_init, lqr_iter=1)
        x_pred, u_pred, cost_pred = _lqr2.forward(x_init, expert['Q'], expert['p'])
