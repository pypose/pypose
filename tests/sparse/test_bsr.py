...
if __name__ == '__main__':
    for i in range(1000):
        test_universal(torch.matmul, torch.matmul, ['bsr', 'bsc'], 'mT', 2, 0.7)
        test_universal(torch.matmul, torch.matmul, ['bsr', 'bsc'], 'identical_square', 2, 0.7)
        test_universal(torch.matmul, torch.matmul, ['bsr', 'bsc'], 'mT', 2, 0.0)
        test_universal(torch.matmul, torch.matmul, ['bsr', 'bsc'], 'identical_square', 2, 0.0)
        test_universal(torch.matmul, torch.matmul, ['bsr', 'bsc'], 'mT', 2, 1.0)
        test_universal(torch.matmul, torch.matmul, ['bsr', 'bsc'], 'identical_square', 2, 1.0)
