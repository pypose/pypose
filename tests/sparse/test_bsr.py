...
class TestBSR:
    ...
    def test_universal(self, op, dense_op, layouts, shape_mode, dim, dense_zero_prob):
        if shape_mode == 'identical':
            ...
            proxy_shapes = [proxy_shape for _ in layouts]
            block_shapes = [block_shape for _ in layouts]
        ...
        args = []
        args_dense = []
        for t, proxy_shape, block_shape, dense_shape in zip(layouts, proxy_shapes,
