    ...
    def test_lqr_linear(self, device='cpu'):
        ...
        x_ref = torch.tensor([
            [[ 1.5000000000000000e+00, -3.4000000357627869e-01, -2.1800000667572021e+00,  5.4000002145767212e-01],
             ...
             [-5.3017884492874146e-02, -2.1380202770233154e+00, 1.5466775894165039e+00,  -1.1694585084915161e+00]],
            [[-1.0499999523162842e+00, -1.3600000143051147e+00,  4.3000000715255737e-01,  8.0000001192092896e-01],
             ...
             [ 5.5056562423706055e+00, -5.6250834465026855e-01,  4.0067559480667114e-01,  2.6752333641052246e+00]]],
            device=device)
    ...
    def test_lqr_ltv(self, device='cpu'):
        ...
        x_ref = torch.tensor([
            [[ 1.5000000000000000e+00, -3.4000000357627869e-01, -2.1800000667572021e+00,  5.4000002145767212e-01],
             ...
             [ 2.0917645263671875e+02, -1.1623557090759277e+01, -2.3242353820800781e+02,  9.3976455688476562e+01]],
            [[-1.0499999523162842e+00, -1.3600000143051147e+00,  4.3000000715255737e-01,  8.0000001192092896e-01],
             ...
             [-7.5823402404785156e+01, -1.1302341461181641e+02,  1.0177659606933594e+02,  1.4617657470703125e+02]]],
            device=device)
