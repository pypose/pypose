...
from pypose.optim.sparse_block_matrix import (
    SparseBlockMatrix )
from pypose.optim.cu_sparse_block_matrix import ( 
    sbm_to_cupy, torch_to_cupy, cupy_to_torch )
from pypose.optim.linear_solver_cu_sparse import LinearSolverCuSparse

# Test utils.
from tests.unit_tests.common import ( torch_equal, torch_equal_rough, show_delimeter )
...
class Test_LinearSolverCuSparse(unittest.TestCase):
    ...
    def test_solve_sym_postive_definite(self):
        ...
        sbm = SparseBlockMatrix(Test_LinearSolverCuSparse.block_shape, dtype=torch.float32, device=device)
